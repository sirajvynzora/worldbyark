...
def response_view(request):
    ...
    request.session["payment_result"] = {
        "status": data[0] if len(data) > 0 else "",
        "message": data[1] if len(data) > 1 else "",
        "error": data[2] if len(data) > 2 else "",
        "txn_ref": data[3] if len(data) > 3 else "",
        "bank_code": data[4] if len(data) > 4 else "",
        "txn_id": data[5] if len(data) > 5 else "",
        "amount": data[6] if len(data) > 6 else "",
        "meta": data[7] if len(data) > 7 else "",
        "date": data[8] if len(data) > 8 else "",
        "balance": data[9] if len(data) > 9 else "",
        "token": data[14] if len(data) > 14 else "",
        "hash": data[15] if len(data) > 15 else "",
    }
